...
function CyclingWord({ onDark }: { onDark: boolean }) {
  ...
  return (
    <span className="relative inline-flex h-7 md:h-8 min-w-[158px] md:min-w-[178px] overflow-visible leading-none -ml-0.5 translate-y-[5px] md:translate-y-[5px]">
