...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="group fixed bottom-24 right-8 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-parchment/20 bg-ink/30 text-cream/90 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.12)] transition-all duration-300 hover:bg-vermillion/70 hover:border-vermillion/30 hover:text-cream hover:shadow-[0_8px_30px_rgba(232,57,14,0.25)]"
    >
